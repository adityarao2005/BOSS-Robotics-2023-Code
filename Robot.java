...
public class Robot extends TimedRobot {
  ...
  // This is wheels
 VictorSP driveLeftA = new VictorSP(0);
 VictorSP driveLeftB = new VictorSP(1);
 VictorSP driveRightA = new VictorSP(3);
 VictorSP driveRightB = new VictorSP(2);
  ...
  public void teleopPeriodic() {
    ...
    double turn = -driverController.getRawAxis(5);//gamepad right joystick
    ...
    driveLeftA.set(driveLeftPower * power);
    driveLeftB.set(driveLeftPower * power);
    driveRightA.set(driveRightPower * power);
    driveRightB.set(driveRightPower * power);
